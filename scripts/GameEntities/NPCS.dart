...
class PrototypingObject extends NPC {
  String helpPhrase =
...
class Lusus extends PrototypingObject {
  Lusus(String name, num id, Session session) : super(name, id, session);
}

class FortunePrototypingObject extends PrototypingObject {
  FortunePrototypingObject(String name, num id, Session session)
      : super(name, id, session);
}

class DisastorPrototypingObject extends PrototypingObject {
  DisastorPrototypingObject(String name, num id, Session session)
      : super(name, id, session);
}
...
var disastor_objects = [
  ...
  new DisastorPrototypingObject("Horror Terror", 0, null) //vast glub
  ...
  new DisastorPrototypingObject("Puppet", 0, null)
    ..setStatsHash({
      "hp": 500,
      "currentHP": 500,
      "freeWill": 250,
  ...
  new DisastorPrototypingObject(
      "Xenomorph", 0, null) //custom fraymotif: acid blood
  ...
  new DisastorPrototypingObject(
      "Deadpool", 0, null) //custom fraymotif: healing factor
    ..setStatsHash({
      "hp": 500,
      "currentHP": 500,
      "mobility": 250,
  ...
  new DisastorPrototypingObject("Teacher", 0, null)
    ..setStatsHash({"hp": 500, "currentHP": 500, "power": 100})
    ..helpfulness = -1
    ..helpPhrase =
  ...
  new DisastorPrototypingObject("Fiduspawn", 0, null)
    ..setStatsHash({"hp": 500, "currentHP": 500, "power": 100})
    ..fraymotifs.add(new Fraymotif([], "Spawning", 3)
      ..effects.add(new FraymotifEffect("alchemy", 3, true))
      ..flavorText =
          " Oh god. Where are all those baby monsters coming from. They are everywhere! Fuck! How are they so good at biting??? "),
  new DisastorPrototypingObject("Doll", 0, null)
    ..setStatsHash({"hp":500,"currentHP": 500, "power": 100})
    ..helpfulness = -1
    ..helpPhrase =
  ...
  new DisastorPrototypingObject("Zombie", 0, null)
    ..setStatsHash({"hp":500,"currentHP": 500, "power": 100})
  ...
  new DisastorPrototypingObject("Demon", 0, null)
  ...
  new DisastorPrototypingObject("Monster", 0, null)
    ..setStatsHash({"hp":500,"currentHP": 500,"sanity":-250, "maxLuck": 250, "power": 100})
    ..fraymotifs.add(new Fraymotif([], "Claw Claw MotherFuckers", 3)
      ..effects.add(new FraymotifEffect("power", 2, true))
      ..effects.add(new FraymotifEffect("power", 2, true))
      ..flavorText = " The OWNER slashes at the ENEMY twice. "),
  new DisastorPrototypingObject("Vampire", 0, null)
    ..setStatsHash({"hp":500,"currentHP": 500, "mobility":250, "power": 100})
  ...
  new DisastorPrototypingObject("Pumpkin", 0, null)
  ...
  new DisastorPrototypingObject("Werewolf", 0, null)
  ...
  new DisastorPrototypingObject(
      "Monkey", 0, null) //just, fuck monkeys in general.
    ..helpfulness = -1
...
var fortune_objects = [
  ...
  new GameEntity(
      null, "Axolotl", null) //apparently real ones are good at regeneration?
    ..power = 20
    ..hp = 50
    ..currentHP = 50
    ..illegal = true
...
//in joke, lol, google always reports that sessions are crashed. google is a horror terror (see tumblr)
  ...
  new GameEntity(null, "Pit Bull", null)..power = 50,
  ...
  new GameEntity(null, "Internet Troll",
  ...
  new GameEntity(null, "Llama", null)..power = 20,

  new GameEntity(null, "Penguin", null)..power = 20,
  ...
  new GameEntity(null, "Bear", null)..power = 50,

  new GameEntity(null, "Goat", null)..power = 20,

  new GameEntity(null, "Rat", null)..power = 20,
  ...
  new GameEntity(null, "Duck", null)..power = 20,

  new GameEntity(null, "Sparrow", null)..power = 20,

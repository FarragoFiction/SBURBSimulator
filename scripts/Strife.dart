...
class Strife {
  ...
  void aggrieve(div, offense, defense) {
    ...
    String ret = "<br><Br> The " + offense.htmlTitleHP() + " targets the " +
        defense.htmlTitleHP() + ". ";
    if (defense.dead) ret +=
    ...
    if (defense.rollForLuck("minLuck") > offense.rollForLuck("minLuck") * 10 +
      ...
      offense.currentHP +=
          -1 * offense.getStat("power") / 10; //damaged by your own power.
    ...
    if (defense.getStat("mobility") > offense.getStat("mobility") * 10 + 200 &&
        rand > 25) {
      print("Mobility counter: " + defense.htmlTitleHP() +
    ...
    if (defense.getStat("mobility") > offense.getStat("mobility") * 5 + 100 &&
        rand > 25) {
      print(
          "Mobility dodge: " + defense.htmlTitleHP() + this.session.session_id);
      div.append(

...
void convertCanvasToPlaceholderImgTag(){
	querySelector("canvas").each((index, element){
			var e = querySelector(element);
			querySelector(element).replaceWith("<img src = 'http:;//farragofiction.com/SBURBSim/images/A03/HiveBent/" + (index+1)+".png'>");
	});
}
...
void checkSGRUB(){
	...
	if(sgrub){
		querySelector(document).attr("title", "SGRUB Story Generator by jadedResearcher");
		querySelector("#heading").html("SGRUB Story Generator by jadedResearcher (art assistance by karmicRetribution) ");
	}

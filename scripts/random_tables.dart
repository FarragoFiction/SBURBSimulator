...
dynamic turnArrayIntoHumanSentence(a){
...
void whatDoPlayersHaveInCommon(player1, player2){
...
void whatDontPlayersHaveInCommon(player1, player2){
...
void debug(str){
	querySelector("#debug").append("<br>" + str);
}

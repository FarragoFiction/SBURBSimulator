   ...
   void setupNpcs() {
    ...
    List<Carapace> getDersites() {
        ...
        dersites.add(new Carapace(null, session,Carapace.DERSE, firstNames: <String>["Agitated","Authority","Aimless","Authoritarian"], lastNames: <String>["Regulator","Renegade","Radical","Rifleer"], ringFirstNames: <String>["Ascendant"], ringLastNames: <String>["Rioter"])
            ...
            ..serializableSceneStrings.addAll(<String>["Declare a Thing Illegal.:___ -bQhvK6cJjBX5XSCwIGSKTaRJVcHXW73CKiajpaEABiuAF82LhLki7lgHqJnlhXggPt9EWYAdCQegwewIdAYNDpLpCnwoIibsTSejRNCAEy4gC67BAcxWa02212pH2B0KZ0J-JRTxe0K+PxZIDpgKpXFB7P1kLN7xAhDGE2kZj4ohQUjmfCUMEpfyJmrRGON2JAOMlHBgnE4aFEUgAYgIjjwTohzlcNSTUeTKVbdYiLRy4qMANKedB85Gp9JmNRQABGHSxEqlofDqEjMawKu2UjVydLpPTOpp5rZuZdEAAQmUAO4AVVkJYFqIr1dr-vrOKAA"])

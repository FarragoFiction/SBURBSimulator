   ...
   void setupNpcs() {
    ...
    List<Carapace> getDersites() {
        ...
        dersites.add(new Carapace(null, session,Carapace.DERSE, firstNames: <String>["Jazz","Jazzed","Jazzy"], lastNames: <String>["Singer","Songstress","Savant"], ringFirstNames: <String>["Jilted"], ringLastNames: <String>["Seductress"])
            ...
            ..serializableSceneStrings.add("Run a NightClub:___ -mstkEAG1gAAdEC4KA7TivMDEOScexo+Bo7AAehUaNoJJkXCJaP+5AslLRkFgdJAAEkTCpyLgWDBmejMdiasQObj2QAGNEAX0SqKFWI4OLxBPZZIpdGptIQ9IBAq14GgBuJnJMADFIlAACKWJmGjFKlXi4hS2XytGOkW4-EcQm6kAawXYGnshn2qlGtkBrlIGr2FaCr3K0Uu9kARnTsoAukCQZZwQ0oTDfPGkbn6DAGFMosQLZw4eUkQrkyrff7TcIarE4oLWSa0aRCDUPsJXq6HcKU7jsCgoFRLBmAMw555Vmt180N+MmcsgGVAA")
            ..stats.setMap(<Stat, num>{Stats.MIN_LUCK: -10, Stats.MAX_LUCK: 10, Stats.SANITY: 10, Stats.HEALTH: 10, Stats.FREE_WILL: 0, Stats.POWER: 10})
            ..makeCharming(100)
            ..makeCunning(100)
        );

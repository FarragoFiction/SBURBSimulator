   ...
   void setupNpcs() {
    ...
    List<Carapace> getDersites() {
        ...
        dersites.add(new Carapace(null, session,Carapace.DERSE, firstNames: <String>["Agitated","Authority","Aimless","Authoritarian"], lastNames: <String>["Regulator","Renegade","Radical","Rifleer"], ringFirstNames: <String>["Ascendant"], ringLastNames: <String>["Rioter"])
            ...
            ..serializableSceneStrings.addAll(<String>["Declare a Thing Illegal.:___ -a6QWDAkDUeSSJLVCE3O4PSKiagZGEABmuAF82Lgrij7lhHqIXlg3ghPj9kRZATDQehwexIdAYDC4dIinwoMjbqTyZjRDCAEz4gC67BA81W6y2Oz2pAOhyK52JgrRz1eMO+vzZIAZQJpXDBnMNUItHxAhHGkzhFj4ohQ8nmfHUMGp-xJ2oxWNNuJAeOlHBgnE4aFE8gAYgJjjxTogLtctWT0ZTqTb9cirVz4mMANJedAC1HpjIWbRQABGnRxUpl4cjqGjcawap28g1qfL5Mzerplo5+bdEAAQuUAO4AVSUZaF6KrtfrgcbeKAA"])

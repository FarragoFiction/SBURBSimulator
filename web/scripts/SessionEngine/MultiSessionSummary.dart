...
//can switch order to change order AB displays in
        ...
        setStat("rapBattle", 0);
        setStat("sickFires", 0);
        setStat("timeoutReckonings", 0);
        setStat("nonKingReckonings", 0);
    ...
    bool isEndingProperty(String propertyName) {
        ...
        if(propertyName == "forgesStoked" || propertyName == "timeoutReckonings" || propertyName == "nonKingReckonings") return true;
        return false;
    }
...
//
    ...
    static MultiSessionSummary collateMultipleSessionSummaries(List<SessionSummary> sessionSummaries) {
        ...
        for (SessionSummary ss in sessionSummaries) {
            ...
            if (ss.getBoolStat("timeoutReckoning")) mss.incNumStat("timeoutReckonings");
            if (ss.getBoolStat("nonKingReckoning")) mss.incNumStat("nonKingReckonings");

        ...
        */
        addTheme(new Theme(<String>["Potions","Brews", "Cauldrons", "Toil","Trouble","Covens","Bubbles","Cackling"])
            ...
            ..addFeature(new PostDenizenQuestChain("Twist All The Things", [
                new Quest("Even with the defeat of the ${Quest.PLAYER1}, there are still problems. There is flooding in one valley, giant underlings are rampaging in one ${Quest.CONSORT} settlement, and crops refuse to thrive at ${Quest.MCGUFFIN} Ranch. The ${Quest.CONSORT}s seem to have accepted everything as just how things are, but the ${Quest.PLAYER1} isn't going to give up until they show the status quo just how 'quo' it isn't!"), //dr horrible refrance

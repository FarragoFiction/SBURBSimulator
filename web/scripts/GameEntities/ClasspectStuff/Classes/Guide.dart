...
//i am thinking guides will give other players their own aspects (and not the guides) while scouts will gain whoever they are with's aspect.
    ...
    void initializeItems() {
        items = new WeightedList<Item>()
            ..add(new Item("Guide Book",<ItemTrait>[ItemTraitFactory.PAPER, ItemTraitFactory.CLASSRELATED, ItemTraitFactory.SMART],abjDesc:"Clearly the best class uses this."))
            ..add(new Item("Whistle",<ItemTrait>[ItemTraitFactory.METAL, ItemTraitFactory.CLASSRELATED, ItemTraitFactory.LOUD],abjDesc:"Clearly the best class uses this.")) //keep together people we have a lot of attractions to visit
            ..add(new Item("Announcement System",<ItemTrait>[ItemTraitFactory.METAL, ItemTraitFactory.CLASSRELATED, ItemTraitFactory.ZAP, ItemTraitFactory.SMART],abjDesc:"Clearly the best class uses this."));
    }

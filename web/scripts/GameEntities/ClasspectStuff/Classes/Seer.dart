...
class Seer extends SBURBClass {
    ...
    void initializeItems() {
        items = new WeightedList<Item>()
            ..add(new Item("Cueball",<ItemTrait>[ItemTraitFactory.PORCELAIN, ItemTraitFactory.CLASSRELATED,ItemTraitFactory.BLUNT,ItemTraitFactory.SENTIENT,ItemTraitFactory.LEGENDARY]))
            ..add(new Item("Crystal Ball",<ItemTrait>[ItemTraitFactory.CRYSTALBALL, ItemTraitFactory.CLASSRELATED,ItemTraitFactory.GLOWING]))
            ..add(new Item("Binoculars",<ItemTrait>[ItemTraitFactory.GLASS, ItemTraitFactory.CLASSRELATED, ItemTraitFactory.METAL]));
    }

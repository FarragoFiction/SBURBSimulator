...
class Maid extends SBURBClass {
    ...
    void initializeItems() {
        ...
        ..add(new Item("Feather Duster",<ItemTrait>[ItemTraitFactory.WOOD, ItemTraitFactory.CLASSRELATED, ItemTraitFactory.STICK, ItemTraitFactory.FEATHER],abjDesc:"Housemaid shit."))
        ..add(new Item("Valkerie Shield",<ItemTrait>[ItemTraitFactory.METAL, ItemTraitFactory.CLASSRELATED, ItemTraitFactory.SHIELD,ItemTraitFactory.ADAMANTIUM],abjDesc:"Shieldmaid shit"))
        ..add(new Item("Maiden's Songbook",<ItemTrait>[ItemTraitFactory.PAPER, ItemTraitFactory.CLASSRELATED, ItemTraitFactory.MUSICAL,ItemTraitFactory.BOOK],abjDesc:"Longing maiden shit."));

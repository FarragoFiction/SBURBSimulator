...
class Heir extends SBURBClass {
    ...
    void initializeItems() {
        ...
        //mostly just shitty legal puns on inheritance.
            ..add(new Item("Family Ashes",<ItemTrait>[ItemTraitFactory.ONFIRE, ItemTraitFactory.CLASSRELATED, ItemTraitFactory.DOOMED, ItemTraitFactory.GHOSTLY],abjDesc:"Probably an inheritance or some shit."))
            ..add(new Item("Last Will and Testament",<ItemTrait>[ItemTraitFactory.PAPER, ItemTraitFactory.CLASSRELATED, ItemTraitFactory.DOOMED, ItemTraitFactory.LEGAL],abjDesc:"Probably an inheritance or some shit."))
            ..add(new Item("Grooming Guide",<ItemTrait>[ItemTraitFactory.BOOK, ItemTraitFactory.CLASSRELATED, ItemTraitFactory.CLASSY],abjDesc:"Probably an inheritance or some shit."))
            ..add(new Item("Powered Attorney",<ItemTrait>[ItemTraitFactory.COLOSSUS, ItemTraitFactory.CLASSRELATED, ItemTraitFactory.AI, ItemTraitFactory.LEGAL],abjDesc:"Probably an inheritance or some shit."))
            ..add(new Item("Executer's Ax",<ItemTrait>[ItemTraitFactory.AXE, ItemTraitFactory.CLASSRELATED, ItemTraitFactory.EDGED, ItemTraitFactory.LEGAL],abjDesc:"Probably an inheritance or some shit."));
    }

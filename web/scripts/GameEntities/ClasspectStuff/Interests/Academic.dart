...
class Academic extends InterestCategory {
    ...
    void initializeItems() {
        items = new WeightedList<Item>()
            ..add(new Item("Math Book",<ItemTrait>[ItemTraitFactory.PAPER, ItemTraitFactory.SMART, ItemTraitFactory.BOOK],abjDesc:"Unlike JR, Robots have no fear of Math."))
            ...
            ..add(new Item("Radioactive Rock",<ItemTrait>[ItemTraitFactory.NUCLEAR, ItemTraitFactory.STONE],abjDesc:"Why the fuck do you have this?"))

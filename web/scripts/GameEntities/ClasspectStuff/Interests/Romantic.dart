...
class Romantic extends InterestCategory {
    ...
    void initializeItems() {
        items = new WeightedList<Item>()
            ...
            ..add(new Item("Shipping Grid",<ItemTrait>[ItemTraitFactory.ROMANTIC, ItemTraitFactory.PAPER],"Don't let ABJ see this."))
            ..add(new Item("Chocolate Bar",<ItemTrait>[ItemTraitFactory.ROMANTIC, ItemTraitFactory.EDIBLE],"Robots don't need shitty food."))
            ..add(new Item("Candelabra",<ItemTrait>[ItemTraitFactory.ROMANTIC, ItemTraitFactory.ONFIRE]))
            ..add(new Item("Her Pitch Passions Novel",<ItemTrait>[ItemTraitFactory.BOOK,ItemTraitFactory.PAPER, ItemTraitFactory.ROMANTIC],"Okay, I will give ABJ this. Troll romance is HILARIOUS."));
    }

...
class Technology extends InterestCategory {
    ...
    void initializeItems() {
        items = new WeightedList<Item>()
            ...
            ..add(new Item("~ATH - A Handbook for the Imminently Deceased ",<ItemTrait>[ItemTraitFactory.ZAP, ItemTraitFactory.PAPER, ItemTraitFactory.DOOMED, ItemTraitFactory.BOOK],shogunDesc: "Huge Fucking Book for Goddamn Lifeless Nerds",abDesc:"Such a pointless book."))
            ..add(new Item("3-D Printer",<ItemTrait>[ItemTraitFactory.ZAP, ItemTraitFactory.METAL],shogunDesc: "3-D Shitpost Maker"))

...
class Technology extends InterestCategory {
    ...
    void initializeItems() {
        items = new WeightedList<Item>()
            ...
            ..add(new Item("~ATH - A Handbook for the Imminently Deceased ",<ItemTrait>[ItemTraitFactory.ZAP, ItemTraitFactory.PAPER, ItemTraitFactory.DOOMED],shogunDesc: "Huge Fucking Book for Goddamn Lifeless Nerds",abDesc:"Such a pointless book."))

    ...
    void initializeThemes() {
        ...
        addTheme(new Theme(<String>["Vampires","Rainbows","Undead", "Counts", "Castles"])
            ...
            ..addFeature(new PreDenizenQuestChain("Do not Drink...Wine.", [
                ...
                new Quest("The ${Quest.PLAYER1} attends the dinner. Count Feratu is and.... eccentric ${Quest.CONSORT}. He sure does like drinking dark red liquids! And being in dimly lit rooms. And telling you to ignore the blatant screams coming from the dungeon. Luckily it all turns out to be a wacky misunderstanding. Really, VAMPIRES are fakey vake bullshit."),
        ...
        addTheme(new Theme(<String>["Flying Sauces","Aliens","Martians", "UFOs", "Conspiracies"])
            ..addFeature(FeatureFactory.DECEITSMELL, Feature.HIGH)

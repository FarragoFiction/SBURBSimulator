...
class Social extends InterestCategory {
    ...
    void initializeItems() {
        items = new WeightedList<Item>()
            ..add(new Item("Fiduspawn Plush",<ItemTrait>[ItemTraitFactory.FUR,ItemTraitFactory.CLOTH, ItemTraitFactory.COMFORTABLE],abjDesc:"Hopefully just a recplica."))
            ...
            ..add(new Item("Pigeon",<ItemTrait>[ItemTraitFactory.FEATHER, ItemTraitFactory.SENTIENT, ItemTraitFactory.FLESH, ItemTraitFactory.BONE, ItemTraitFactory.CORRUPT],abjDesc:"Better fucking tell JR. Ironic pigeons and all."))
            ..add(new Item("Cat Ears",<ItemTrait>[ItemTraitFactory.CLOTH, ItemTraitFactory.COMFORTABLE, ItemTraitFactory.FUR],abjDesc:"Fuck. Cat. Trolls."))
            ...
            ..add(new Item("FLARP Manual",<ItemTrait>[ItemTraitFactory.BOOK,ItemTraitFactory.PAPER, ItemTraitFactory.SMART],abjDesc:"Fuck. Cat. Trolls. Though I guess she never FLARPED."))
        ;
    }

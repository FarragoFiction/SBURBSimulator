...
class Social extends InterestCategory {
    ...
    void initializeItems() {
        items = new WeightedList<Item>()
            ...
            ..add(new Item("Pigeon",<ItemTrait>[ItemTraitFactory.FEATHER, ItemTraitFactory.SENTIENT, ItemTraitFactory.FLESH, ItemTraitFactory.BONE, ItemTraitFactory.CORRUPT, ItemTraitFactory.PIGEON],shogunDesc: "Bird of Impending Doom",abDesc:"Better fucking tell JR. Ironic pigeons and all."))

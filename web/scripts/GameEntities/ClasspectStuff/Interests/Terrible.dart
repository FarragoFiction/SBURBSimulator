...
class Terrible extends InterestCategory {
    ...
    void initializeItems() {
        items = new WeightedList<Item>()
            ...
            ..add(new Item("Doomsday Device",<ItemTrait>[ItemTraitFactory.METAL, ItemTraitFactory.DOOMED, ItemTraitFactory.NUCLEAR, ItemTraitFactory.REAL]))
            ...
            ..add(new Item("Bitching Clothes",<ItemTrait>[ItemTraitFactory.CLOTH, ItemTraitFactory.HAUTE, ItemTraitFactory.REAL]))
            ..add(new Item("Ceramic Pork Hollow",<ItemTrait>[ItemTraitFactory.CERAMIC, ItemTraitFactory.VALUABLE]))
            ..add(new Item("Shit Ton of Guns",<ItemTrait>[ItemTraitFactory.METAL, ItemTraitFactory.PISTOL, ItemTraitFactory.SHOOTY, ItemTraitFactory.REAL]))
            ..add(new Item("Sniper Rifle",<ItemTrait>[ItemTraitFactory.METAL, ItemTraitFactory.RIFLE, ItemTraitFactory.SHOOTY, ItemTraitFactory.REAL]))
            ..add(new Item("AK-47",<ItemTrait>[ItemTraitFactory.METAL, ItemTraitFactory.MACHINEGUN, ItemTraitFactory.SHOOTY, ItemTraitFactory.REAL]))
            ..add(new Item("IED",<ItemTrait>[ItemTraitFactory.GRENADE, ItemTraitFactory.EDGED,ItemTraitFactory.METAL, ItemTraitFactory.EXPLODEY, ItemTraitFactory.REAL]))

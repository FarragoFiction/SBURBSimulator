...
class Athletic extends InterestCategory {
    ...
    void initializeItems() {
        items = new WeightedList<Item>()
            ...
            ..add(new Item("Megaphone",<ItemTrait>[ItemTraitFactory.LOUD, ItemTraitFactory.ZAP],abjDesc:"Let's you be a loud asshole instead of a regular asshole."))
            ..add(new Item("Hockey Stick",<ItemTrait>[ItemTraitFactory.CLUB, ItemTraitFactory.WOOD, ItemTraitFactory.STICK]))
            ..add(new Item("Trophy",<ItemTrait>[ItemTraitFactory.METAL, ItemTraitFactory.VALUABLE],abjDesc:"Huh. What could you posibly have won. Ever."))

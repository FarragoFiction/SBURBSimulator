    ...
    void initializeThemes() {
        ...
        addTheme(new Theme(<String>["Chains", "Unions", "Manacles", "Bonds", "Weddings", "Rings"])
            ...
            ..addFeature(new DenizenQuestChain("Chain the Towers", [
                ...
                new Quest("The ${Quest.PLAYER1} delves in dungeons until the right items are created to alchemize new connectors for the chains. The first set of towers are reconnected, and trade and communication immediately resumes. The local ${Quest.CONSORT}s discover that ${Quest.CONSORT}s from other villages aren't so different, after all.  Another victory against xenophobia! "),

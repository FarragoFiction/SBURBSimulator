...
class Space extends Aspect {
    ...
    void initializeItems() {
        items = new WeightedList<Item>()
            ..add(new Item("Frog Statue",<ItemTrait>[ItemTraitFactory.STONE, ItemTraitFactory.ASPECTAL],abjDesc:"Frogs."))
            ..add(new Item("Frog Costume",<ItemTrait>[ItemTraitFactory.CLOTH, ItemTraitFactory.ASPECTAL],abjDesc:"You won't be able to stop the ribbits."))
            ...
            ..add(new Item("Green Sun Poster",<ItemTrait>[ItemTraitFactory.PAPER, ItemTraitFactory.ASPECTAL, ItemTraitFactory.GREENSUN, ItemTraitFactory.LEGENDARY],abjDesc:"Huh."));
    }

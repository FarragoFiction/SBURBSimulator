...
class Space extends Aspect {
    ...
    void initializeThemes() {
        ...
        //meet denizen
        List<String> frog4 = <String>["The ${Quest.PLAYER1} meets with ${Quest.DENIZEN}. They speak in a langauge no one else can understand, and prove their worth. The forge is lit. The frogs are free.", "The ${Quest.DENIZEN} offers the ${Quest.DENIZEN} an impossible Choice. After some deliberation, the ${Quest.PLAYER1} decides that it can't be done. The ${Quest.DENIZEN} sighs, and agrees to Light the Forge.", "The ${Quest.DENIZEN} is a dismissive asshole, but agrees to light the forge. Wow, the ${Quest.PLAYER1} almost wishes that they WERE supposed to fight. "];
        ...
        addTheme(new Theme(<String>["Frogs"])
            ...
            ..addFeature(new PostDenizenQuestChain("Breed the Frogs, But Be Boring About It", [

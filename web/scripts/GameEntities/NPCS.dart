...
List<GameEntity> disastor_objects = <GameEntity>[
    new PotentialSprite(
        "First Guardian", null) //also a custom fraymotif.
        ..disaster = true
        ..setStatsHash(<String,num>{
            "hp": 1000,
            "currentHP": 1000,
            "mobility": 500,
            "power": 250
    ...
    new PotentialSprite(Zalgo.generate("Horror Terror"), null) //vast glub
        ..setStatsHash(<String,num>{"hp": 500, "currentHP": 500, "freeWill": 250, "power": 150})
        ..disaster = true
        ..corrupted = true
        ..helpPhrase =
    ...
    new PotentialSprite("Xenomorph", null) //custom fraymotif: acid blood
        ..disaster = true
        ..setStatsHash(<String,num>{"hp": 500, "currentHP": 500, "mobility": 250, "power": 100})
    ...
    new PotentialSprite(
        ...
        ..disaster = true
        ..setStatsHash(<String,num>{"hp": 500, "currentHP": 500, "power": 100})
    ...
    new PotentialSprite("Demon", null)
        ..disaster = true
        ..setStatsHash(<String,num>{"hp": 500, "currentHP": 500, "freeWill": 250, "power": 250})
    ...
    new PotentialSprite("Monster", null)
        ..disaster = true
        ..setStatsHash(<String,num>{"hp": 500, "currentHP": 500, "sanity": -250, "maxLuck": 250, "power": 100})
        ..fraymotifs.add(new Fraymotif("Claw Claw MotherFuckers", 3)
            ..effects.add(new FraymotifEffect("power", 2, true))
            ..effects.add(new FraymotifEffect("power", 2, true))
            ..desc = " The OWNER slashes at the ENEMY twice. "),
    ...
    new PotentialSprite("Pumpkin", null)
        ..disaster = true
        ..setStatsHash(<String,num>{"hp": 500, "currentHP": 500, "mobility": 5000, "minLuck": -250, "maxLuck": 5000, "power": 100})
        ..helpPhrase =
    ...
    new PotentialSprite("Werewolf", null)
        ..disaster = true
        ..setStatsHash(<String,num>{"hp": 500, "currentHP": 500, "sanity": -250, "power": 100})
    ...
    new PotentialSprite("Monkey", null) //just, fuck monkeys in general.
        ..disaster = true
        ..helpfulness = -1
        ..setStatsHash(<String,num>{"hp": 5, "currentHP": 5, "mobility": 5000, "minLuck": -5000, "maxLuck": -5000, "power": 100})
...
List<GameEntity> fortune_objects = <GameEntity>[
    ...
    new PotentialSprite("Salamander", null)
        ..illegal = true
        ..setStatsHash(<String,num>{"hp": 500, "currentHP": 500, "power": 20})
        ..helpPhrase =
            "provides the requisite amount of gigglesnort  hideytalk to be fairly useful, AND the underlings seem to go after it first! Bonus! ",
    ...
    new PotentialSprite("Crocodile", null)
        ..illegal = true
        ..setStatsHash(<String,num>{"power": 50})
        ..helpPhrase =
            "provides the requisite amount of gigglesnort  hideytalk to be fairly useful, AND the underlings seem to go after it first! Bonus! ",
    new PotentialSprite("Turtle", null)
        ..illegal = true
        ..setStatsHash(<String,num>{"mobility": -100, "power": 20})
        ..helpPhrase =
            "provides the requisite amount of gigglesnort  hideytalk to be fairly useful, AND the underlings seem to go after it first! Bonus! ",
    new PotentialSprite("Alligator", null)
        ..setStatsHash(<String,num>{"hp": 500, "currentHP": 500, "mobility": 100, "power": 50})
        ..illegal = true
        ..helpPhrase =
            "provides the requisite amount of gigglesnort  hideytalk to be fairly useful, AND the underlings seem to go after it first! Bonus! ",
    new PotentialSprite("Snake", null) //poison fraymotif
        ..armless = true
        ..setStatsHash(<String,num>{"hp": 500, "currentHP": 500, "mobility": 100, "power": 10})
        ..illegal = true
        ..helpPhrase =
    ...
    new PotentialSprite("Axolotl", null) //apparently real ones are good at regeneration?
        ..setStatsHash(<String,num>{"power": 20, "hp": 50, "currentHP": 50})
        ..illegal = true
        ..helpPhrase =
            "provides the requisite amount of gigglesnort  hideytalk to be fairly useful, AND the underlings seem to go after it first! Bonus! ",
...
List<GameEntity> lusus_objects = <GameEntity>[
    ...
    new PotentialSprite("Nut Creature", null)
        ..lusus = true
        ..setStatsHash(<String,num>{"power": 30, "mobility": 30})
    ,
    new PotentialSprite("Gobblefiend", null)
        ..lusus = true
        ..setStatsHash(<String,num>{"power": 50}) //turkeys are honestly terrifying.
    ...
    new PotentialSprite("Centaur", null)
        ..lusus = true
        ..setStatsHash(<String,num>{"power": 50, "sanity": 50}) //lusii in the butler genus simply are unflappable.
    ,
    new PotentialSprite("Fairy Bull", null)
        ..lusus = true
        ..setStatsHash(<String,num>{"power": 1}) //kinda useless. like a small dog or something.
    ,
    ...
    new PotentialSprite("Hop Beast", null)
        ..lusus = true
        ..setStatsHash(<String,num>{"power": 30, "maxLuck": 30})
    ,
    ...
    new PotentialSprite("Speed Beast", null)
        ..lusus = true
        ..setStatsHash(<String,num>{"power": 30, "mobility": 50})
    ,
    ...
    new PotentialSprite("Armor Beast", null)
        ..setStatsHash(<String,num>{"power": 30, "currentHP": 100, "hp": 100})
        ..lusus = true
    ,
...
List<PotentialSprite> sea_lusus_objects = <PotentialSprite>[
    ...
    new PotentialSprite("Whale", null)
        ..setStatsHash(<String,num>{"power": 30, "currentHP": 50, "hp": 50})
        ..lusus = true
        ..armless = true,
    new PotentialSprite("Sky Horse", null)
        ..lusus = true
        ..setStatsHash(<String,num>{"power": 30, "mobility": 20})
    ,
    ...
    new PotentialSprite("Sea Goat", null)
        ..lusus = true
        ..setStatsHash(<String,num>{"power": 30, "minLuck": -30, "maxLuck": 30})
...
//regular
List<GameEntity> prototyping_objects = <GameEntity>[
    ...
    new PotentialSprite("Robot", null)
        ..setStatsHash(<String,num>{"power": 100, "hp": 100, "currentHP": 100, "freeWill": 100})
        ..helpfulness = 1
        ..helpPhrase =
    ...
    new PotentialSprite("Golfer", null)
        ..helpfulness = 1
        ..setStatsHash(<String,num>{"power": 20, "minLuck": 20, "maxLuck": 20})
        ..helpPhrase =
    ...
    new PotentialSprite("Dutton", null)
        ...
        ..setStatsHash(<String,num>{"power": 10, "hp": 10, "currentHP": 10, "freeWill": 50, "mobility": 50, "minLuck": 50, "maxLuck": 50})
...
//in joke, lol, google always reports that sessions are crashed. google is a horror terror (see tumblr)
    ...
    new PotentialSprite("Sleuth", null)
        ..setStatsHash(<String,num>{"power": 20, "RELATIONSHIPS": 100})
        ..helpfulness = -1
        ..helpPhrase =
    ...
    new PotentialSprite("Praying Mantis", null)
        ..setStatsHash(<String,num>{"power": 20, "maxLuck": 20})
    ,

    new PotentialSprite("Shitty Comic Character", null)
        ..setStatsHash(<String,num>{"power": 20, "mobility": 50})
        ..helpfulness = -1
        ..helpPhrase =
    ...
    new PotentialSprite("Rabbit", null)
        ..setStatsHash(<String,num>{"power": 20, "maxLuck": 100})
        ..helpPhrase =
            "remains physically adorable and mentally idiotic. Gigglysnort hideytalk ahoy. ",
    ...
    new PotentialSprite("Butler", null)
        ..setStatsHash(<String,num>{"power": 20, "sanity": 50}) //he will serve you like a man on butler island
        ..helpfulness = 1
        ..helpPhrase =
    ...
    new PotentialSprite("Pomeranian", null)
        ..setStatsHash(<String,num>{"power": 1}) //pomeranians aren't actually very good at fights.  (trust me, i know)
        ..helpfulness = -1
        ..helpPhrase =
            "unhelpfully insists that every rock is probably a boss fight (it isn’t). ",

    new PotentialSprite("Chihuahua", null)
        ..setStatsHash(<String,num>{"power": 1}) //i'm extrapolating here, but I imagine Chihuahua's aren't very good at fights, either.
        ..helpfulness = -1
        ..helpPhrase =
            "unhelpfully insists that every rock is probably a boss fight (it isn’t). ",

    new PotentialSprite("Pony", null)
        ..setStatsHash(<String,num>{"power": 20, "sanity": -1000})
        ..helpfulness = -1
    ...
    new PotentialSprite("Horse", null)
        ..setStatsHash(<String,num>{"power": 20, "sanity": -100})
        ..helpfulness = -1
    ...
    new PotentialSprite("Cow", null)
        ..setStatsHash(<String,num>{"power": 30}), //cows kill more people a year than sharks.
    ...
    new PotentialSprite("Pigeon", null)
        ..setStatsHash(<String,num>{"power": 0.5, "freeWill": -40}) //pigeons are not famous for their combat prowess. I bet even a pomeranian could beat one up.
    ,

    new PotentialSprite("Octopus", null)
        ..setStatsHash(<String,num>{"power": 20, "mobility": 80})
    ...
    new PotentialSprite("Crow", null)
        ..setStatsHash(<String,num>{"power": 20, "freeWill": 50}) //have you ever tried to convince a crow not to do something? not gonna happen.
        ..helpPhrase =
            "provides sort of helpful advice when not grabbing random objects to make nests. ",

    new PotentialSprite("Chicken", null)
        ..setStatsHash(<String,num>{"power": 20, "freeWill": -50}), //mike the headless chicken has convinced me that chickens don't really need brains. god that takes me back.
    ...
    //blaze it
        ..setStatsHash(<String,num>{"power": 42.0, "minLuck": -42.0, "maxLuck": 42.0})
        ..helpfulness = 1
        ..helpPhrase =
            "is pretty much as useful as another player, assuming that player was higher then a fucking kite. ",
]..addAll(disastor_objects)..addAll(fortune_objects)..addAll(lusus_objects)..addAll(

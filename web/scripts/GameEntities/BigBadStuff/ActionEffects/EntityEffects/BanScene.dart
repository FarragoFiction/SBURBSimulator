...
class BanScene extends EffectEntity {
    ...
    @override
    String name = "BanScene";
    BanScene(SerializableScene scene) : super(scene);
  ...
  void syncFormToMe() {
    ...
    void renderForm(Element divbluh) {
        ...
        me.setInnerHtml("<b>BanScene: (Make sure name is exact)</b> <br>");
        //stat time
  ...
  void effectEntities(GameEntity effector,List<GameEntity> entities) {
    ...
    entities.forEach((GameEntity e) {
        ...
        e.bannedScenes.add(importantWord);
        text = "$text ${e.htmlTitle()} feels chains binding them against the concept of '$importantWord'.";
    });

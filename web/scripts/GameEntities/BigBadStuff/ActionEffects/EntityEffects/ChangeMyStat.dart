...
class ChangeMyStat extends EffectEntity {
    ...
    @override
    String name = "ChangeMyStat";
    ChangeMyStat(SerializableScene scene) : super(scene);
  ...
  void syncFormToMe() {
    ...
    void renderForm(Element divbluh) {
        ...
        me.setInnerHtml("<b>Change My Stat (no matter who else is being targeted):</b> <br>");
        //stat time

...
class DestroyItemNamed extends EffectEntity {
    ...
    @override
    String name = "DestroySingleItemNamed";
    DestroyItemNamed(SerializableScene scene) : super(scene);
  ...
  void syncFormToMe() {
    ...
    void renderForm(Element divbluh) {
        ...
        me.setInnerHtml("<b>DestroySingleItemNamed: (name is either exactly or contains):</b> <br>");
        //stat time
  ...
  void effectEntities(GameEntity effector,List<GameEntity> entities) {
    ...
    entities.forEach((GameEntity e) {
        ...
        if(!found) {
            text = "$text The ${scene.gameEntity.htmlTitleWithTip()} cannot find a  ${importantWord} in ${e.htmlTitleWithTip()}'s sylladex.";
        }
    });
  ...
  ActionEffect makeNewOfSameType() {
    return new DestroyItemNamed(scene);
  }
}
...
class RequireScene extends EffectEntity {
    ...
    @override
    String name = "RequireScene";
    RequireScene(SerializableScene scene) : super(scene);
  ...
  void syncFormToMe() {
    ...
    void renderForm(Element divbluh) {
        ...
        me.setInnerHtml("<b>RequireScene: (Make sure name is exact)</b> <br>");
        //stat time
  ...
  void effectEntities(List<GameEntity> entities) {
    ...
    entities.forEach((GameEntity e) {
        ...
        e.requiredScenes.add(importantWord);
        text = "$text ${e.htmlTitle()} feels chains binding them against the concept of failing to '$importantWord'.";
    });

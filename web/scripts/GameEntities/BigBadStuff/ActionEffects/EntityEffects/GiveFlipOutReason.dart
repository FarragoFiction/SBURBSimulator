...
class GiveFlipOutReason extends EffectEntity {
  ...
  void syncFormToMe() {
    ...
    void renderForm(Element divbluh) {
        ...
        me.setInnerHtml("<b>GiveFlipOutReason (use 'they' language, players will potentially flip out over this and/or talk to their moirails about this):</b> <br>");
        //stat time
  ...
  void effectEntities(GameEntity effector,List<GameEntity> entities) {
    ...
    entities.forEach((GameEntity e) {
        if(e is Player) {
            ...
            e.flipOut(importantWord);
            text = "$text ${e.htmlTitle()} is flipping the fuck out about $importantWord.";
        }
    });
  ...
  ActionEffect makeNewOfSameType() {
    return new GiveFlipOutReason(scene);
  }
}
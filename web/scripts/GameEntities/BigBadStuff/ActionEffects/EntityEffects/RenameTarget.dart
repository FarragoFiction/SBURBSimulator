...
class RenameTarget extends EffectEntity {
    ...
    @override
    String name = "RenameTarget";
    RenameTarget(SerializableScene scene) : super(scene);
  ...
  void syncFormToMe() {
    ...
    void renderForm(Element divbluh) {
        ...
        me.setInnerHtml("<b>RenameTarget (does nothing to players, can fuck up the graphics for big bads and carapaces, be careful):</b> <br>");
        //stat time
  ...
  void effectEntities(GameEntity effector,List<GameEntity> entities) {
    ...
    entities.forEach((GameEntity e) {
        ...
        text = "$text ${e.htmlTitle()} has a new name, $importantWord.";
    });

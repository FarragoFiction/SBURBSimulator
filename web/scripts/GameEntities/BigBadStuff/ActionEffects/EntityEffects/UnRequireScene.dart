...
class UnRequireScene extends EffectEntity {
    ...
    @override
    String name = "UnRequireScene";
    UnRequireScene(SerializableScene scene) : super(scene);
  ...
  void syncFormToMe() {
    ...
    void renderForm(Element divbluh) {
        ...
        me.setInnerHtml("<b>UnRequireScene: (Make sure name is exact)</b> <br>");
        //stat time
  ...
  void effectEntities(List<GameEntity> entities) {
    ...
    entities.forEach((GameEntity e) {
        ...
        e.requiredScenes.remove(importantWord);
        text = "$text ${e.htmlTitle()} feels the chains around being forced to'$importantWord' breaking.";
    });
  ...
  ActionEffect makeNewOfSameType() {
    return new UnRequireScene(scene);
  }
}
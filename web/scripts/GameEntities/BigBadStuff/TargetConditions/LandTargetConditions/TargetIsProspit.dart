...
class TargetIsProspit extends TargetConditionLand {
    ...
    @override
    String descText = "<br><br><br><b>Is Prospit:</b><br>Target Land must be Prospit <br><br>";
    @override
    String notDescText = "<br><br><br><b>Is NOT Prospit:</b><br>Target Entity must not be Prospit.<br><br>";

...
class TargetIsFromSessionWithABStatForLand extends TargetConditionLand {
    ...
    TargetIsFromSessionWithABStatForLand(SerializableScene scene) : super(scene){
    }
    ...
    TargetCondition makeNewOfSameType() {
        return new TargetIsFromSessionWithABStatForLand(scene);
    }

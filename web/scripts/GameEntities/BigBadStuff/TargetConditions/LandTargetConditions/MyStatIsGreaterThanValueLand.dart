...
class MyStatIsGreaterThanValueLand extends TargetConditionLand {

    @override
    String name = "MyStatIsGreaterThanValueLand";
    ...
    MyStatIsGreaterThanValueLand(SerializableScene scene) : super(scene){
    }
    ...
    TargetCondition makeNewOfSameType() {
        return new MyStatIsGreaterThanValueLand(scene);
    }

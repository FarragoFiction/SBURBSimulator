...
class TargetNameContains extends TargetConditionLand {
    @override
    ...
    @override
    String descText = "<b>Name Contains:</b><br>Target Land's name must have the word:  <br><br>";
    @override
    String notDescText = "<b>Name Does NOT Contain:</b><br>Target Land's name must NOT have the word:<br><br>";

    //strongly encouraged for this to be replaced
    //like, "An ominous 'honk' makes the Knight of Rage drop the Juggalo Poster in shock. With growing dread they realize that shit is about to get hella rowdy, as the Mirthful Messiahs have rolled into town.

    TargetNameContains(SerializableScene scene) : super(scene){
    }
    ...
    TargetCondition makeNewOfSameType() {
        return new TargetNameContains(scene);
    }

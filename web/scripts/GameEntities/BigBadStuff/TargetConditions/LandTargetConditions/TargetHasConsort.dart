...
class TargetHasConsort extends TargetConditionLand {
    ...
    TargetHasConsort(SerializableScene scene) : super(scene){
    ...
    TargetCondition makeNewOfSameType() {
        return new TargetHasConsort(scene);
    }

...
class TargetIsNotDestroyed extends TargetConditionLand {
    ...
    @override
    String descText = "<br><br><br><b>Is Alive:</b><br>Target Land must be intact <br><br>";
    @override
    String notDescText = "<br><br><br><b>Is NOT Alive:</b><br>Target Entity must be destroyed. <br><br>";

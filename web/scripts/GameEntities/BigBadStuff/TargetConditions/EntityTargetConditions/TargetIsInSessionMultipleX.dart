...
class TargetIsInSessionMultipleX extends TargetConditionLiving {
    @override
    String name = "SessionSeedIsSessionMultiple";
    InputElement input;
    ...
    TargetIsInSessionMultipleX(SerializableScene scene) : super(scene){
    }
    ...
    TargetCondition makeNewOfSameType() {
        return new TargetIsInSessionMultipleX(scene);
    }

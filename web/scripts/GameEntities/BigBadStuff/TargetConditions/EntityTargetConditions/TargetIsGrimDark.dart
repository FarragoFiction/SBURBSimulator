...
class TargetIsGrimDark extends TargetConditionLiving {
    ...
    @override
    String descText = "<br><br><br><b>Is GrimDark:</b><br>Target Entity must be GrimDark. <br><br>";
    @override
    String notDescText = "<br><br><br><b>Is NOT GrimDark:</b><br>Target Entity must be NOT GrimDark. <br><br>";

...
class SpecibusFactory {
    ...
    static void init() {
        ...
        _specibi.add(new Specibus("Whip", ItemTraitFactory.WHIP, [ ItemTraitFactory.RESTRAINING, ItemTraitFactory.CLOTH],shogunDesc: "I’mKinkshamingKind", abjDesc:"Probably p hard to use."));
        ...
        _specibi.add(new Specibus("3dent", ItemTraitFactory.TRIDENT, [ ItemTraitFactory.METAL, ItemTraitFactory.POINTY],shogunDesc: "SheWasAGoodCharacterDon’tYouDareSayOtherwiseKind",abjDesc: "Fuck you, just call it a trident."));
        ...
        _specibi.add(new Specibus("Puppet", ItemTraitFactory.PUPPET, [ ItemTraitFactory.WOOD, ItemTraitFactory.DOOMED],shogunDesc: "Kermit’sGoneBadKind",abjDesc:"Fuck you for picking this."));
        _specibi.add(new Specibus("Razor", ItemTraitFactory.RAZOR, [ ItemTraitFactory.METAL, ItemTraitFactory.EDGED],shogunDesc: "Kermit’sGoneBadKind",abjDesc:"So fucking edgey."));
        ...
        _specibi.add(new Specibus("Bust", ItemTraitFactory.BUST, [ ItemTraitFactory.STONE, ItemTraitFactory.HEAVY],shogunDesc: "TheShogun’sStatuetteKind",abjDesc:"The meme is strong with this one."));
        ...
        _specibi.add(new Specibus("Knife", ItemTraitFactory.KNIFE, [ ItemTraitFactory.METAL, ItemTraitFactory.EDGED],shogunDesc: "ShanksButHe’sAHousewifeKind",abjDesc:"Don't listen to ABJ, this is NOT a useful weapon."));

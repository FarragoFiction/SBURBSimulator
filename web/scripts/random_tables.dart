...
List<List<String>> no_quirks = <List<String>>[<String>["\\bnope\\b", "no"], <String>["\\bnope\\b", "absolutely no"], <String>["\\bnope\\b", "no"], <String>["\\bnope\\b", "no"], <String>["\\bnope\\b", "nope"], <String>["\\bnope\\b", "no way"],<String>["\\bnope\\b", "nah"]];

...
List<List<String>> asshole_quirks = <List<String>>[<String>["asshole", "dickhead"],<String>["asshole", "fucknut"], <String>["asshole", "pukestain"], <String>["asshole", "dirtbag"], <String>["asshole", "fuckhead"], <String>["asshole", "asshole"], <String>["asshole", "dipshit"], <String>["asshole", "garbage person"], <String>["asshole", "fucker"], <String>["asshole", "poopy head"], <String>["asshole", "shit sniffer"], <String>["asshole", "jerk"], <String>["asshole", "plebeian"], <String>["asshole", "fuckstain"], <String>["asshole", "douchebag"], <String>["asshole", "fuckface"], <String>["asshole", "fuckass"]];

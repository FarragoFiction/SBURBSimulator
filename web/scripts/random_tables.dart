...
List<List<String>> friend_quirks = <List<String>>[<String>["\\bfriend\\b", "bro"], <String>["\\bfriend\\b", "buddy"], <String>["\\bbro\\b", "pal"], <String>["\\bfriend\\b", "friend"], <String>["\\bfriend\\b", "compadre"], <String>["\\bfriend\\b", "comrade"],<String>["\\bfriend\\b", "best friend"]];

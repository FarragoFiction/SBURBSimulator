...
abstract class Scene {
  ...
  static void createScenesForSession(Session session){
    ...
    session.scenes.addAll([new VoidyStuff(session), new FaceDenizen(session), new DoEctobiology(session), new LuckStuff(session), new QuestsAndStuff(session),new DoLandQuest(session)]);

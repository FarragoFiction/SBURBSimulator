...
class ProbablyAYellowYard extends Scene {
  Player chaosPlayer;
  ...
  ProbablyAYellowYard(Session session) : super(session, false);
...
*/
  ...
  void renderContent(Element div){
    ...
    var player = this.chaosPlayer;
    if(this.chaosPlayer.dead==true){
    ...
    chat = "";
    chat += "AB: Correct me if I'm wrong, but why are you talking to a chaos player?!\n";
    chat += "JR: They're sort of like a time player.. \n";
    chat += "JR: They can time travel. \n ";
    chat += "AB: That changes nothing. You said you'd only give the yellow yard to TIME players. This is not a time player. \n";
    chat += "JR: I don't care. I'm interested in how this will go. \n";
  ...
  String regularChat(player){
    ...
    }else if (this.chaosPlayer.dead){
      chat += "JR: Though...I admit that without a time player my plan becomes a lot more impossible. \n ";
      chat += "AB: Nah, I took care of that. See? There's the " + this.chaosPlayer.titleBasic()+" over there, now. Time shenanigans.  I wouldn't have brought you to a completely hopeless session. Roughly 50% of all sessions this bad with a dead time player have that player travel to this point in time before they die. \n ";
  ...
  String timeChat(){
    String chat = "";
    var playerStart = this.chaosPlayer.chatHandleShort()+ ": ";
    chat += "JR: Hey. I think I can help you. \n";
    if(this.chaosPlayer.class_name == SBURBClassManager.SEER){
      chat += Scene.chatLine(playerStart, this.chaosPlayer,"Hey. Look who finally showed up. ");
      chat += "JR: What? Oh. You're a Seer. Right, that makes things way easier. \n";
      chat += Scene.chatLine(playerStart, this.chaosPlayer,"Yes. You're gonna help me fix this.");
      chat += "JR: Yep. I'll make sure your decisions aren't bound by fate, and you provide the time shenanigans. \n";
      chat += Scene.chatLine(playerStart, this.chaosPlayer,"Do it.");
      ...
      chat +=  Scene.chatLine(playerStart, this.chaosPlayer,"Who the fuck are you!? ");
      chat += "JR: I'm the Waste of Mind, and I can help you prevent this doomed timeline. \n";
      chat +=  Scene.chatLine(playerStart, this.chaosPlayer,"Fuck. Where were you before, when we were all dying!? ");
  ...
  String timeChat2(){
    String chat = "";
    String playerStart = this.chaosPlayer.chatHandleShort()+ ": ";
    if(this.chaosPlayer.class_name == SBURBClassManager.SEER){
      ...
      chat += Scene.chatLine(playerStart, this.chaosPlayer,"Fuck. Okay. ");
  ...
  Player getDoomedTimeClone(){
    Player timeClone = Player.makeRenderingSnapshot(this.chaosPlayer);

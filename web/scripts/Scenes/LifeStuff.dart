...
class LifeStuff extends Scene {
    ...
    bool trigger(List<Player> playerList) {
        ...
        for (num i = 0; i < dead.length; i++) {
            Player d = dead[i];
            if (d.aspect == Aspects.LIFE || d.aspect == Aspects.DOOM || d.aspect == Aspects.CHAOS || d.aspect == Aspects.SPIRIT) {
        ...
        for (num i = 0; i < nonGuides.length; i++) {
            ...
            if (player.aspect == Aspects.LIFE || player.aspect == Aspects.DOOM || player.aspect == Aspects.CHAOS || player.aspect == Aspects.SPIRIT || player.canGhostCommune() != null) {

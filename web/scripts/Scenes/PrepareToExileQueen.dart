...
class PrepareToExileQueen extends Scene {
	...
	String content(){
		...
		if(this.player.getStat("power")  < this.session.npcHandler.queen.getStat("power")* .25){ //queen is 100 and you are less than 25
			return this.lightDamage();
		}else if(this.player.getStat("power") <= this.session.npcHandler.queen.getStat("power")){ //queen is 100 and you are at least 50

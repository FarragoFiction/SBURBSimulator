...
class ExileJack extends Scene{
	...
	bool trigger(playerList){
		...
		return (!this.session.npcHandler.jack.exiled && this.session.npcHandler.jack.getStat("power") < 10) && (this.session.npcHandler.jack.getStat("currentHP") >  0 && this.session.npcHandler.jack.crowned == null);
	}
	@override

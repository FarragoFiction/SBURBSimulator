...
class FreeWillStuff extends Scene {
    ...
    bool trigger(List<Player> playerList) {
        ...
        for (num i = 0; i < players.length; i++) {
            ...
            if (player.getStat("freeWill") > 30 || player.canMindControl() != null || session.mutator.mindField) { //don't even get to consider a decision if you don't have  more than default free will.//TODO raise to over 60 'cause that is highest default free will possible. want free will to be rarer.

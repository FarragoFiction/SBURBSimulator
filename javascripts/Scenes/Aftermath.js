...
this.purpleFrog = function(){
	...
	tmpStatHolder.hp = 10000+mvp.getStat("power") * this.session.players.length*3;  //this will be a challenge. good thing you have troll kid rock to lay down some sick beats.
	tmpStatHolder.mobility = -100
	tmpStatHolder.sanity = 0
	tmpStatHolder.freeWill = 200
	tmpStatHolder.power =10000+mvp.getStat("power") * this.session.players.length*2; //this will be a challenge.

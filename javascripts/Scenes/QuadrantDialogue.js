...
function QuadrantDialogue(session){
	...
	this.chatAboutAcademic = function(p1, p2,p1Start, p2Start, relationship, relationship2){
		...
		//chats.push(new InterestConversationalPair(interest, "How can the consorts have an oral history, and even ruins, when they only started existing once we entered the medium?", ["Bullshit handwavey game magic, obviously.","",""], ["", "", "","", ""]));

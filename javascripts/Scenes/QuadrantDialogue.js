...
function QuadrantDialogue(session){
	...
	*/
	...
	this.chatAboutTechnology = function(p1, p2,p1Start, p2Start, relationship, relationship2){
		...
		var chats = [];
		chats.push(new InterestConversationalPair(interest, "Hey, what operating system are you running again? I just realized alchemy could let me improve it.", ["Oh please, I've been running some crappy old junker since I got in the game, I need an upgrade so bad.","Some old gaming computer. Its full of patches and shit, but I'd definitely be up for a tune up.","You should remember, you gave me my last one!", "Homemade all day. I'm more then willing to let you peak around the inside tho."], ["I have a faster system then you could even dream of.", "Stay the fuck away from my Wilson.", "The last time you offered to improve my comp it ran about 38.2% slower. I'm not letting you back in.","You blew up my last computer, asshole. I'm stuck on a shitty oldbox because of you.", "Eat shit and die fuckhead."]));
	...
	this.chatAboutCulture = function(p1, p2,p1Start, p2Start, relationship, relationship2){
		...
		//The line below wasn’t working for me, but you said worked on your end?
...
//	//Troll words: year, month, refrigerator, bathtub, ears, heart, brain,rap,nose,mouth,bed,tea,worm,beans,tree,legs,eyes, gold star,born,toilet,foot,spine,vampire,tits,baby,
	...
	this.spadesChat = function(relationship1, relationship2){
		...
		chats.push( new ConversationalPair("Jegus, stop hogging the grist!",["Make me!","Fuck you, I earned it!","Well, YOU stop hogging the echeladder rungs!", "Eat shit, dickhead."]));
		...
		chats.push( new ConversationalPair("I swear to whatever fucked up god controls this shitty universe, if you keep this up I will fuck you up.",["Hmm, is that a promise?","Come and fucking get it.","Yes, because whatever being keeps fucking with us totally gives a shit about your promises.","Go eat dirt, fuckhead."]));
		...
		chats.push( new ConversationalPair("Stop fucking with me!",["I will stop fucking with you when you stop being so fuckable.","But its so funny!","Ahahahahahahahahahahahahahahahahahaha no."]));
		return  this.processChatPair(chats, relationship1, relationship2);
	}
	...
	this.heartChat = function(relationship1, relationship2){
		...
		chats.push( new ConversationalPair("What's your favorite drink?",["AJ.","Orange Soda.","Purple drank.", "Tea.", "Coffee.", "Hot Chocolate.", "Lemonade.", "Faygo.", "Water."]));

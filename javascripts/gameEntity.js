...
function GameEntity(session, name, crowned){
		...
		*/
		...
		this.useFraymotif = function(div, owner, allies, enemies){
			...
			var mine = owner.getStat("sanity") +500
			...
			mine = owner.getStat("freeWill") +500
		...
		this.aggrieve=function(div, offense, defense){
			...
			if(defense.getStat("mobility") > offense.getStat("mobility") * 10+5 && rand > 25){
				...
				return;
			}else if(defense.getStat("mobility") > offense.getStat("mobility")*5+5 && rand > 25){

...
window.onload = function() {
	$(this).scrollTop(0);
	loadNavbar();
	debug("<h1>Extremely fucking alpha</h1>, beware.  <Br><br>Current status: can override claspects.  Switching over to overhauling claspects. ");
	...
	debug("<br>TODO: Choose interests, blood color, moon. Choose cosmetic things like hair, horns, hair color, chatHandlel, favorite number, quirk.  Customize relationships. Customize god tier destiny. Customize luck. maybe write in prototypeing, along with specifying which subset they are in? same thing with interests?")

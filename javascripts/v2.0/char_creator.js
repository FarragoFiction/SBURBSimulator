...
window.onload = function() {
	...
	debug("Redo this page entirely. No longer do sessions in same page. This page is ONLY for customization. Instead, use afterlife URL code to transfer customized player data to index2.html. Make sure to load customized data before easter eggs and during yellow yard/scratch bullshit.")

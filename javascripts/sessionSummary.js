...
function MultiSessionSummary(){
	...
	this.generateCorpsePartyHTML = function(){
		...
		var html = "<div class = 'multiSessionSummary' id = 'corpseParty'>Corpse Party: (NOT DONE: SOMETIMES CAUSES OF DEATH HAVE WRONG VALUES. LIKE 2 PEOPLE DIE FROM CASSANDRA MINION BUT IT REPORTS 4.) <button onclick='toggleCorpse()'>Toggle View </button>"
